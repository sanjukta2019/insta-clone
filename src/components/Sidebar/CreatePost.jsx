	...
	const handleCreatePost = async (selectedFile, caption) => {
		...
		try {
			...
			console.log("Added post id to user document");
			// Upload image to Cloudinary
			const uploadResult = await uploadToCloudinary(selectedFile);

			// Save image URL + public ID
			...
			newPost.imagePublicId = uploadResult.public_id;
...
//import { Box, Button, Flex, Input, Modal, ModalBody, ModalCloseButton, ModalHeader, ModalOverlay, Textarea, Tooltip } from "@chakra-ui/react";
...
// 	const handlePostCreation = async () =>{
// 		try {
// 			await handlePostCreation(selectedFile, caption);
// 			onClose();
// 			setCaption("");
// 			setSelectedFile(null);			
// 		}catch (error){
